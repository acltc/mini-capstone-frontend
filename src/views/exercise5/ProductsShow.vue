    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-3">
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div v-for="(image, index) in product.images" :class="{'carousel-item': true, active: index === 0}">
        ...
        <div class="col-9">
          ...
          <button v-if="isAdmin()" type="button" class="btn btn-warning mr-1" data-toggle="modal" data-target="#deleteModal">
            Delete product
          </button>
