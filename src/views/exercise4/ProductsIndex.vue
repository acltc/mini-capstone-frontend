<template>
  <div class="home">
    ...
    <div class="container">
      <h1>Products</h1>
      <a href="/"></a>
      <router-link :to="{ name: 'exercise4-products-index', query: { sort: 'price', sort_order: 'asc' } }" append class="btn btn-light">Sort by lowest price</router-link>
      <router-link :to="{ name: 'exercise4-products-index', query: { sort: 'price', sort_order: 'desc' } }" append class="btn btn-light">Sort by highest price</router-link>
      <router-link :to="{ name: 'exercise4-products-index', query: { discount: true } }" append class="btn btn-light">Show only discounted</router-link>
      <router-link :to="{ name: 'exercise4-products-index' }" append class="btn btn-light">Show all</router-link>
      <div class="card-columns">
        <div v-for="product in products" class="card">
          ...
          <div class="card-body">
            ...
            <router-link :to="{ name: 'exercise4-products-show', params: { id: product.id } }" append class="btn btn-info">More info</router-link>
          </div>
        </div>
      </div>
    </div>
