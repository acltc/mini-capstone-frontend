  ...
  <div class="signup">
    <div class="container">
      <form v-on:submit.prevent="submit();">
        ...
        <div class="form-group"><label>Password confirmation:</label> <input type="password" class="form-control" v-model="passwordConfirmation" /></div>
  ...
  methods: {
    submit: function() {
      ...
      axios
        ...
        .then(response => {
          this.$router.push({ name: "exercise4-login" });
        })
        .catch(error => {
