  ...
  <div class="home">
    ...
    <div class="collapse" id="collapseDebugInfo">
      <div class="card card-body">
        ...
        <p><strong>Using params</strong>: <strong>name</strong>, <strong>price</strong>, <strong>description</strong> (can't edit images or supplier)</p>
      </div>
    </div>
    <div class="container">
      <form v-on:submit.prevent="submit();">
        ...
        <router-link :to="{ name: 'exercise3-products-show', params: { id: product.id } }" class="btn btn-secondary">Cancel</router-link>
      </form>
    </div>
  </div>
</template>
  ...
  methods: {
    submit: function() {
      ...
      axios
        ...
        .then(response => {
          this.$router.push({ name: "exercise3-products-show", params: { id: response.data.id } });
        })
        .catch(error => {
