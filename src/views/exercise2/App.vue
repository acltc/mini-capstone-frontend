<template>
  <div class="app">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <router-link :to="{ name: 'exercise2-products-index'}" class="navbar-brand">{{ appConfig.name }}</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <router-link :to="{ name: 'exercise2-products-index'}" class="nav-link">All products</router-link>
          </li>
          <li class="nav-item">
            <router-link :to="{ name: 'exercise2-products-new' }" class="nav-link">New product</router-link>
          </li>
        </ul>
